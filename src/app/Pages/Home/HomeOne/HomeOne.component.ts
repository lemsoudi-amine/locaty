...
export class HomeoneComponent implements OnInit, AfterViewChecked {
   ...
   public onFeaturedSelectedTab(tabIndex) {
      ...
      switch (tabIndex) {
         case 0:
            this.productsSliderData = this.productsArray.caftan;
         break;

         case 1:
          this.productsSliderData = this.productsArray.tekchita;
         break;

         case 2:
            this.productsSliderData = this.productsArray.jellaba;
         break;
         default:
            // code...
            break;
   ...
   public onNewArrivalsSelectedTab(tabIndex) {
      ...
      switch (tabIndex) {
         case 0:
            this.newProductsSliderData = this.productsArray.caftan;
         break;

         case 1:
            this.newProductsSliderData = this.productsArray.tekchita;
         break;

         case 2:
            this.newProductsSliderData = this.productsArray.jellaba;
         break;
         default:
            // code...
            break;
